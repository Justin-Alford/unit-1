// Initialize cities and debugAjax functions called when script loads
function initialize(){
    cities();
    debugAjax();
};
...
// Create a function to use data from fetch request
function debugCallback(response){
    // stringify converts fetched JSON data into string
...
function debugAjax(){    
	// Fetch request with file location as parameter
	fetch("data/MegaCities.geojson")  
		.then(function(response){
            return response.json();
        })
        // Pass JSON data to debugCallback function
        .then(debugCallback);         
